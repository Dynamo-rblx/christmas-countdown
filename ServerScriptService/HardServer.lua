-- @ScriptType: Script
----------------------------------------------------------CONFIGURATION---------------------------------------------------------
local placeId = 85019213730135 --The ID of the place to teleport to
...
local rs = game.ReplicatedStorage:WaitForChild("HardPartyRS")
local re = rs:WaitForChild("RE")
local parties = rs:WaitForChild("HardParties")

local tps = game:GetService("TeleportService")

local ms = game:GetService("MemoryStoreService")
local queue = ms:GetSortedMap("HQueueStore")
